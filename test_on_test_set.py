...
def get_args_parser():
    parser = argparse.ArgumentParser('DETR testing script', add_help=False)
    ...
    parser.add_argument('--resume', default='', required=True, help='resume from checkpoint')
...
def main(args):
    ...
    if args.output_dir:
        ...
        utils.save_on_master(coco_evaluator.coco_eval["bbox"].eval, output_dir / "test_eval.pth")
